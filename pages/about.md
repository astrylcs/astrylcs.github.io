...
## Nasıl görüşeceğiz?
Doğum haritası analizinin görüşmelerini <a href="mailto:{{ site.theme_settings.email_address }}">e-posta</a> ile size göndereceğim formdaki bilgi ve sorular üzerinden, yazmış olacağım rapora bağlı kalarak soracağınız sorularla skype, whatsapp, messenger, telefonda yapılabilir.
